...
class ServiceLocator {
  ...
  T get<T>() {
    ...
    if (_services.containsKey(type)) {
      debugPrint('ServiceLocator: Returning singleton instance of ${type.toString()}');
    ...
    if (_factories.containsKey(type)) {
      ...
      debugPrint('ServiceLocator: Creating instance from factory ${type.toString()}');
      
      final instance = factory();
      
      // If it's a Future, throw an error - use getAsync instead
      if (instance is Future) {
        throw Exception('Service $type requires async initialization. Use getAsync<$type>() instead.');
      }
    ...
    throw Exception('Service of type $type is not registered. Please register it first.');
  }
  ...
  Future<T> getAsync<T>() async {
    ...
    if (_factories.containsKey(type)) {
      final factory = _factories[type]!;
      debugPrint('ServiceLocator: Creating instance from async factory ${type.toString()}');
