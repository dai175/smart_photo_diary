...
class InAppPurchaseConfig {
  ...
  static SubscriptionPlan getSubscriptionPlan(String productId) {
    switch (productId) {
      case 'smart_photo_diary_premium_monthly':
        return SubscriptionPlan.premiumMonthly;
      case 'smart_photo_diary_premium_yearly':
  ...
  /// Premium年額プランの価格（円）
  static int get premiumYearlyPrice => 
  ...
  /// Premium月額プランの表示名
  static String get premiumMonthlyDisplayName => 
      'Premium Monthly Plan';
      
  /// Premium年額プランの表示名
  static String get premiumYearlyDisplayName => 
      'Premium Yearly Plan';
  ...
  /// テスト用商品IDプレフィックス
  static String get testProductIdPrefix => 
      isSandboxEnvironment ? 'test_' : '';
