...
class EmotionPromptCategorySpecs {
  ...
  /// 【狙い】: 深い自己洞察と感情パターンの理解
  static const EmotionDepthCategorySpec emotionDepthCategory = EmotionDepthCategorySpec();
  ...
  /// 【狙い】: 多感覚的な感情記憶の保存と再体験
  static const SensoryEmotionCategorySpec sensoryEmotionCategory = SensoryEmotionCategorySpec();
  ...
  /// 【特徴】: 感情体験を通じた個人的成長の記録
  /// 【狙い】: 感情的成熟と自己発達の追跡
  static const EmotionGrowthCategorySpec emotionGrowthCategory = EmotionGrowthCategorySpec();
  ...
  /// 【狙い】: 関係性における感情体験の深化
  static const EmotionConnectionCategorySpec emotionConnectionCategory = EmotionConnectionCategorySpec();
  ...
  /// 【狙い】: 感情の多様性認識と自己発見の促進
  static const EmotionDiscoveryCategorySpec emotionDiscoveryCategory = EmotionDiscoveryCategorySpec();
  ...
  static const EmotionFantasyCategorySpec emotionFantasyCategory = EmotionFantasyCategorySpec();
  ...
  /// 【狙い】: 感情的回復力と心の平安の育成
  static const EmotionHealingCategorySpec emotionHealingCategory = EmotionHealingCategorySpec();
  ...
  static const EmotionEnergyCategorySpec emotionEnergyCategory = EmotionEnergyCategorySpec();
}
...
class EmotionEnergyCategorySpec {
  ...
  List<String> get recommendedTags => [
    '感情エネルギー', '活力', 'エネルギー', '源', '力',
    '強い感情', '動かされた', 'インパクト', '印象', '情熱',
  ];
}