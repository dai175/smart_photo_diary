...
void main() {
  group('DiaryService', () {
    ...
    setUp(() {
      ...
      // Create DiaryService with mocked dependencies
    ...
    group('saveDiaryEntry', () {
      test('should save diary entry with required fields', () async {
        // Arrange
      ...
      test('should save diary entry with optional fields', () async {
        // Arrange
        final testDate = DateTime(2024, 1, 15, 14, 30);
        const title = 'Test Title';
        const content = 'Test Content';
    ...
    group('saveDiaryEntryWithPhotos', () {
    ...
    group('updateDiaryEntry', () {
      test('should update diary entry', () async {
        ...
        // Act - This will work after Hive initialization in integration tests
        // For unit tests, we just verify the method can be called
        expect(
          () => diaryService.updateDiaryEntry(updatedEntry),
          returnsNormally,
        );
      });
    });
    ...
    group('deleteDiaryEntry', () {
      test('should delete diary entry by ID', () async {
        // Arrange
    ...
    group('Fallback Tags Generation', () {
    ...
    group('Statistics Methods', () {
      test('should return total diary count', () async {
        ...
        // For unit tests, we just verify the method can be called
        expect(
          () => diaryService.getTotalDiaryCount(),
          returnsNormally,
        );
      });
      ...
      test('should return diary count in period', () async {
        ...
        // For unit tests, we just verify the method can be called
        expect(
          () => diaryService.getDiaryCountInPeriod(start, end),
          returnsNormally,
        );
      });
    });
