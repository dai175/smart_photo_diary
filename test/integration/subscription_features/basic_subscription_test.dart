...
void main() {
  group('Phase 3.1.1: サブスクリプション機能基本テスト', () {
    ...
    test('3.1.1.3: 使用量制限テスト（Basic 10回制限）', () async {
      ...
      expect(status.monthlyUsageCount < status.currentPlan.monthlyAiGenerationLimit, isTrue);
    ...
    test('3.1.1.9: 残りAI生成回数計算テスト', () async {
      ...
      final remaining = status.currentPlan.monthlyAiGenerationLimit - status.monthlyUsageCount;
      ...
      final premiumRemaining = premiumStatus.currentPlan.monthlyAiGenerationLimit - premiumStatus.monthlyUsageCount;
